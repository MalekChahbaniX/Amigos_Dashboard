...
type OrderStatus = "pending" | "confirmed" | "accepted" | "preparing" | "collected" | "in_delivery" | "delivered" | "cancelled";
...
const statusConfig = {
  ...
  collected: { label: "Collecté", className: "bg-orange-500/10 text-orange-600 dark:text-orange-400 hover:bg-orange-500/20" },
